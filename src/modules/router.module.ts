    ...
    },
    {
        path: 'cabinet', canActivate: [AuthGuardServices], component: IndexComponent, children: [
            ...
            },
            {
                ...
                data: { title: 'Storage', indexed: true },
                canActivate: [CanActivatePageGuard]
            },
            {
                path: 'marketplace',
                component: MarketplaceComponent,
                data: { title: 'Marketplace', indexed: true },
                canActivate: [CanActivatePageGuard]
            },
            {
                path: 'settings',
            ...
            {
                path: 'tariff',
                component: TariffPlansComponent,
                data: { title: 'Tariff Plan', indexed: true }
            },
            {
            ...
            },
            {
                path: 'blank',
                component: BlankComponent,
                data: { title: 'Blank Component', indexed: true }
            },
        ]
    },
