...
export class WsServices {
  ...
  connectionLost: Subject<void> = new Subject<void>();
  connectionRestored: Subject<void> = new Subject<void>();
  ...
  constructor(private socket: Socket,
    ...
    socket.on('notification', function (data) {
      ...
      _this.refs.request.logout();
      _this.message.writeError('You already have an authorized session running', 10000);
